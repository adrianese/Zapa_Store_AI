...
const Carrito = () => {
  ...
  // Normalizar precio - soportar tanto price_minor como precio
  const getPrecio = (item) => {
    if (item.price_minor !== undefined) {
      return item.price_minor / 100;
    }
                    ...
                    <li key={`${item.id}-${item.talle}-${i}`} className="item-carrito">
                      ...
                      <div className="detalle-carrito">
                        <div className="info-producto">
                          ...
                          {item.talle && <p className="talle-producto">Talle: {item.talle}</p>}
